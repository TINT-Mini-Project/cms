...
public class EditCourse extends javax.swing.JFrame {
    ...
    private void updateJcomboBox(){
        ...
        try {
            ...
            PreparedStatement query2 = con.prepareStatement("SELECT Title FROM Books");
            ...
            names.forEach((String n) -> jComboBox1.addItem(n));
            titles.forEach((String n) -> jComboBox2.addItem(n));
    ...
    private void initComponents() {
        ...
        jTextField1.setText("New Course");
        ...
        jComboBox2.setFont(new java.awt.Font("Product Sans", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Connection con = DBManager.getConnection();
            PreparedStatement query = con.prepareStatement("UPDATE Courses SET Name = ?, Instructor = ?, Book = ? WHERE ID = ?");
            ...
            if(i == 1){
                JOptionPane.showMessageDialog(null, i + " Course Edited!");
                dispose();
            }
            else
